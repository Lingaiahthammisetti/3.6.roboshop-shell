...
cp /home/ec2-user/3.4.roboshop-shell/catalogue.service /etc/systemd/system/catalogue.service &>> $LOGFILE
...
cp /home/ec2-user/3.4.roboshop-shell/mongo.repo /etc/yum.repos.d/mongo.repo &>> $LOGFILE
